...
def _load_base_url() -> str:
    """Resolve public app URL from environment configuration."""
...
# Deployment readiness smoke coverage: public routes, Next API health, public pages API, chatbot API.
...
def test_public_pages_api_returns_real_content(api_client):
