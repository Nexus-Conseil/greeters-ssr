        ...
        <div className="site-container">
          ...
          <div className="site-gallery-grid" data-testid="public-home-gallery-grid">
            {items.map((item, index) => (
              ...
              >
                <Image src={item.src} alt={item.title} width={480} height={480} className="site-gallery-image" data-testid={`public-home-gallery-image-${item.id}`} />
        ...
        <div className="site-modal-backdrop" data-testid="public-home-gallery-lightbox" onClick={() => setActiveIndex(null)}>
          <div className="site-lightbox-panel" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="site-lightbox-media">
              <Image src={items[activeIndex].src} alt={items[activeIndex].title} width={1200} height={900} className="site-lightbox-image" data-testid="public-home-gallery-lightbox-image" />
