...
import { ProgressiveImage } from "@/components/public/media/ProgressiveImage";
...
const FileTextGlyph = () => (
  <svg viewBox="0 0 24 24" aria-hidden="true">
    <path fill="currentColor" d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6Zm1 7V3.5L18.5 9H15Zm-7 4h8v1.5H8V13Zm0 3h8v1.5H8V16Zm0-6h3v1.5H8V10Z" />
  </svg>
);

const ImageGlyph = () => (
  <svg viewBox="0 0 24 24" aria-hidden="true">
    <path fill="currentColor" d="M5 3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm0 2h14v10.2l-3.8-3.8a1 1 0 0 0-1.4 0l-2.2 2.2-1.6-1.6a1 1 0 0 0-1.4 0L5 15.6V5Zm9 1.5a2 2 0 1 1 0 4 2 2 0 0 1 0-4ZM5 18.4l3.8-3.8 1.6 1.6a1 1 0 0 0 1.4 0l2.2-2.2 5 5H5Z" />
  </svg>
);

const MailGlyph = () => (
  <svg viewBox="0 0 24 24" aria-hidden="true">
    <path fill="currentColor" d="M3 5h18a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm0 2v.5l9 5.63 9-5.63V7l-9 5.63L3 7.01ZM21 17V9.84l-8.47 5.3a1 1 0 0 1-1.06 0L3 9.84V17h18Z" />
  </svg>
);
        ...
        <div className="site-content-shell-narrow site-content-section" data-testid="presse-public-page-content">
          <section className="site-highlight-panel site-press-panel" data-testid="presse-kit-panel">
            <div className="site-press-heading-row">
              <span className="site-press-icon" data-testid="presse-kit-icon"><FileTextGlyph /></span>
              <div>
          ...
          <section className="site-block-stack site-press-panel" data-testid="presse-photos-section">
            <div className="site-press-heading-row">
              <span className="site-press-icon" data-testid="presse-photos-icon"><ImageGlyph /></span>
            ...
            <div className="site-press-photo-grid" data-testid="presse-photo-grid">
              {PRESS_PHOTOS.map((photo) => (
                <a key={photo.id} href={photo.src} target="_blank" rel="noreferrer" className="site-gallery-card site-press-photo-card" data-testid={`presse-photo-link-${photo.id}`}>
                  <ProgressiveImage src={photo.src} alt={photo.title} sizes={PUBLIC_GALLERY_GRID_SIZES_ATTR} lowQuality={36} highQuality={IMAGE_QUALITY_GALLERY} className="site-gallery-image" wrapperClassName="site-progressive-image-fill" />
          ...
          <section className="site-info-panel site-press-panel" data-testid="presse-contact-panel">
            <div className="site-press-heading-row">
              <span className="site-press-icon" data-testid="presse-contact-icon"><MailGlyph /></span>
