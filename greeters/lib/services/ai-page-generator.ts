...
function convertPlanToPage(plan: AiPagePlan, locale: AppLocale): PageInput {
  ...
  return {
    ...
    metaTitle: asString(plan.title, "Nouvelle page touristique"),
    ...
    ogTitle: asString(plan.title, "Nouvelle page touristique"),
    ogDescription: asString(plan.metaDescription, "Découvrez une page touristique générée automatiquement par le CMS."),
    ogImageUrl: plan.sections.find((section) => asString(section.imageUrl))?.imageUrl || null,
    ogImageAlt: plan.sections.find((section) => asString(section.imageAlt))?.imageAlt || null,
    twitterTitle: asString(plan.title, "Nouvelle page touristique"),
    twitterDescription: asString(plan.metaDescription, "Découvrez une page touristique générée automatiquement par le CMS."),
    twitterImageUrl: plan.sections.find((section) => asString(section.imageUrl))?.imageUrl || null,
    focusKeyword: null,
...
function sanitizeGeneratedPage(page: PageInput, locale: AppLocale): PageInput {
  return {
    ...
    ogImageAlt: page.ogImageAlt ?? null,
    twitterTitle: page.twitterTitle ?? page.metaTitle ?? page.title,
    twitterDescription: page.twitterDescription ?? page.metaDescription,
    twitterImageUrl: page.twitterImageUrl ?? page.ogImageUrl ?? null,
    focusKeyword: page.focusKeyword ?? null,
    secondaryKeywords: page.secondaryKeywords ?? null,
    schemaOrgJson: page.schemaOrgJson ?? null,
    imageRecommendations: Array.isArray(page.imageRecommendations) ? page.imageRecommendations : [],
    sitemapPriority: typeof page.sitemapPriority === "number" ? page.sitemapPriority : 0.7,
